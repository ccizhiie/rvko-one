...
describe('Register Page Tests', () => {
  ...
  it('Jika user melakukan click terhadap tombol sign up seharusnya pindah ke halaman register', async () => {
    render(
...
it('Jika user melakukan click terhadap register tanpa inputan seharusnya ada error', async () => {
  render(  <I18nextProvider i18n={i18next}>
        <MemoryRouter initialEntries={['/']}>
            <Routes>
